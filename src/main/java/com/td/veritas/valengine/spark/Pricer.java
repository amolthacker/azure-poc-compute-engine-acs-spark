...
public class Pricer {
    ...
    static double computeSwapNPV()
    {
        ...
        for(int i = 1; i < Curve.dateVector().size(); i++){
            index.addFixing(Curve.dateVector().get(i), 0.0d);
        }
        */
        Fixings.add(index);
    ...
    // re-using example : https://github.com/lballabio/QuantLib-SWIG/blob/master/Java/examples/FRA.java
    ...
    // re-using example : https://github.com/lballabio/QuantLib-SWIG/blob/master/Java/examples/EquityOptions.java
